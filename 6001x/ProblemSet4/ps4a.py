    ...
    while calculateHandlen(hand) > 0:
        ...
        # Otherwise (the input is not a single period):
            ...
            # Otherwise (the word is valid):
                ...
                scoreupdate = getWordScore(word, n)
                score += scoreupdate
                print('"{}"'.format(word), "earned", scoreupdate, "points. Total:", score, "points")
                print("")
                # Update the hand
...
# Checking to see if the game runs...

# wordList = loadWords()
# playHand({'m':1, 'e':1, 'a':1, 'b':1, 'u':1, 'l':2, 'r':1}, wordList, 8)
